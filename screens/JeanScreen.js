  ...
  constructor(props) {
    ...
    this.state = {
      medicoes: [
        ...
        {tipo: require('../assets/png/015-snow.png'), temperatura_maxima: 33, temperatura_minima: 27, dia_semana: 'Quarta'},
        {tipo: require('../assets/png/042-rain.png'), temperatura_maxima: 4, temperatura_minima: 1, dia_semana: 'Quinta'},
    ...
    return (
      <View style={{justifyContent: 'center', alignSelf: 'center', backgroundColor: '#D1F4F6',}}>
        ...
        <View style={styles.header}>
          <Text style={styles.texto_H1}>Maranhão</Text>
          <Text style={styles.texto_H2}>São Luís</Text>
        </View>
        <FlatList
          horizontal = {true}
